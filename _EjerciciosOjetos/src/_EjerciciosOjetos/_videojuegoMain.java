...
public class _videojuegoMain {

	public static void main(String[] args) {
		_videojuego v1 = new _videojuego();
		_videojuego v2 = new _videojuego(827397162, "Call of Duty", 8, 59.99, "15/11/2022", false);
		_videojuego v3 = new _videojuego("FIFA 23", "20/02/2023");
